...
public class GameBackUp extends JFrame implements ActionListener {
	Animator ani;
	BarLeft barLeft;
	BarRight barRight;
	Ball ball;
	...
	public GameBackUp() {
		ball = new Ball((Constant.BOX_WIDTH - Constant.BAR_WIDTH - Constant.BALL_SIZE),(Constant.BOX_HEIGHT/2), 7, 3);
		barLeft = new BarLeft(0,(Constant.BOX_HEIGHT/2 - Constant.BAR_HEIGHT/2),0,3);
		barRight = new BarRight(Constant.BOX_WIDTH-Constant.BAR_WIDTH,(Constant.BOX_HEIGHT/2 - Constant.BAR_HEIGHT/2),0,4);
		ani = new Animator(ball, barLeft, barRight);
		timer = new Timer(300, this);
		setSize(Constant.BOX_WIDTH +3,Constant.BOX_HEIGHT+100);
