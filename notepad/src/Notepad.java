...
public class Notepad extends JFrame implements ActionListener {
	...
	private MenuItem find = new MenuItem();
	...
	public Notepad() {
		...
		this.textArea.setFont(new Font("Century Gothic", Font.PLAIN, 12)); // set a default font for the TextArea
	...
	public int find(String str){
		...
		//int pos1 = textArea.getText().indexOf(str, pos);
		String strTemp = textArea.getText();
		strTemp = strTemp.replace("\r","");
		int pos1 = strTemp.indexOf(str, pos);	
		if (pos1 != -1) {
			int pos2 = pos1+str.length();
			textArea.select(pos1, pos2);			
		}
		this.setVisible(true);	// This motherfucker to update the view, otherwise you won't see the selection show up
		return 0;
